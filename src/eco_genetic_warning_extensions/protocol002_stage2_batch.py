...
five calibration master seeds by five replicates. Only source preparation,
projection, baseline eligibility, and realised trait-loss timing are retained.
"""
...
def _failed_attempt(base: dict[str, Any], *, status: str, source_prepared: bool, projection_supported: bool | None) -> dict[str, Any]:
    return {
        **base,
        "status": status,
