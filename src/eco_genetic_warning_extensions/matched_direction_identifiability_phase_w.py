...
SAME_STRENGTH_CELLS = (
    LockedStage2Cell(p_star=0.10, batch_index=282, artifact_id=8260028479, artifact_digest="sha256:a88a1c5614054263ad08290acadb671977ae1d66e428c2c2dcc9936c5d21a0a9", baseline_eligible=22, trait_loss=22, seed_blocks=((4, 4), (4, 4), (5, 5), (4, 4), (5, 5))),
    LockedStage2Cell(p_star=0.25, batch_index=336, artifact_id=8260079020, artifact_digest="sha256:07201c3e7704b60eb85961390ab9641267279f520574b67b619237606578e2e9", baseline_eligible=17, trait_loss=17, seed_blocks=((3, 3), (4, 4), (2, 2), (3, 3), (5, 5))),
    LockedStage2Cell(p_star=0.50, batch_index=390, artifact_id=8260125567, artifact_digest="sha256:4b842a4ccc113309623c87d1c2228dfa9abc36d93d4598b28c4bc72fc984a42e", baseline_eligible=20, trait_loss=8, seed_blocks=((5, 3), (3, 2), (3, 0), (5, 3), (4, 0))),
    LockedStage2Cell(p_star=0.75, batch_index=444, artifact_id=8260180102, artifact_digest="sha256:df96e9d5951b1f9a03afed3efbf9a86f973d2ec62cbe041d221cada341020d5b", baseline_eligible=21, trait_loss=0, seed_blocks=((5, 0), (4, 0), (3, 0), (5, 0), (4, 0))),
    LockedStage2Cell(p_star=0.90, batch_index=498, artifact_id=8260233506, artifact_digest="sha256:fc8b53ef8a24038d6f728655d2bec20bd5acbd01812c6439ae08e07a7c23fd83", baseline_eligible=22, trait_loss=0, seed_blocks=((5, 0), (3, 0), (4, 0), (5, 0), (5, 0))),
)
