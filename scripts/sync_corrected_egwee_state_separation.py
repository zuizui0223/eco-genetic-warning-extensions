...
def main() -> None:
    ...
    text = text.replace('for token in ("Fisher chi-square(8)=27.70", "p=5.35e-4", "p=0.000535", "delta NLL M1-M0=-0.0003211"):', 'for token in ("Fisher chi-square(6)=18.01", "p=0.00621", "p=0.00257", "delta NLL M1-M0=-0.0003211"):')
    text = text.replace('for token in ("Serapias", "Brosimum", "Spondias", "Eucalyptus wandoo", "p=0.000535"):', 'for token in ("Serapias", "Brosimum", "Spondias", "Eucalyptus wandoo", "p=0.00621", "p=0.00257"):')
