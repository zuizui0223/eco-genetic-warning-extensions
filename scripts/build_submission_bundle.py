...
def _figure1(path: Path) -> None:
    lines = [
        '<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="620" viewBox="0 0 1080 620" role="img" aria-labelledby="figure1-title figure1-desc">',
        '<title id="figure1-title">Genetic warning emerges from eco-genetic closure</title>',
        '<desc id="figure1-desc">Conceptual diagram linking fragmentation, interaction state, functional-trait state, local demography, genetic state, relative diversity warning, and functional-trait loss. Closure modifiers alter warning feasibility, ordering, censoring, and intervention time.</desc>',
