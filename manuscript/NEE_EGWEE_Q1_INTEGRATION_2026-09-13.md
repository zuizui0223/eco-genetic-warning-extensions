# NEE flagship — EGWEE natural Q1 integration

**Status:** manuscript integration contract after EGWEE formal synthesis completion.

## Scientific change

The NEE flagship should no longer say that natural systems are only qualitative Discussion projections or that EGWEE contributes no numerical result.
...
## Required Introduction replacement
...
After the existing fixed-area fragmentation paragraph and before Question 2, add:
...
The opening of Question 2 should explicitly say:
...
## Required Discussion boundary

The Discussion should distinguish three levels:

- **portable empirical result:** biological fragmentation layers are not generally exchangeable;
- **finite mechanistic result:** cross-layer covariance, q-dependent sorting, recruitment buffering, direct recoupling and density feedback explain how relational state can alter fate in the declared closure;
- **failed first natural Q2 transfer:** the locked strongest-refuge natural prospective test gave delta NLL M1-M0=-0.0003211, species-bootstrap 95% CI [-0.0009825,+0.0003422], so incremental strongest-refuge information was not detected.

The natural null must remain a boundary. Do not promote the secondary persistence-only direction, change the metric, or claim that the finite AUC 0.9273 has natural validation.
...
The new NEE claim is **not** “EGWEE validates EGWE.” It is:

> Natural systems independently support the premise that fragmentation responses occupy multiple biological state dimensions; the finite model then supplies one explicit causal architecture showing why hidden cross-layer organization can matter once such state separation exists.
